...
export default function PageProductivity() {
    ...
    <div id="page-productivity-container" className="flex flex-col gap-5 text-left font-sans">
      ...
      <div id="productivity-header-block" className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-2 border-b border-[#dfe1e6]">
        ...
        <button
          ...
          className="self-start md:self-auto h-[32px] px-3 bg-[#0052cc] hover:bg-[#0747a6] text-white font-bold rounded-[3.5px] text-[11px] flex items-center gap-1.5 transition-colors cursor-pointer disabled:bg-slate-100 disabled:text-[#a5adba] disabled:cursor-not-allowed"
        >
      ...
      <div id="metrics-summary-grid" className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-[#f4f5f7] border border-[#dfe1e6] rounded-[4px] p-4 flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold text-[#5e6c84] uppercase tracking-wide">Total Duration Monitored</span>
        ...
        <div className="bg-[#f4f5f7] border border-[#dfe1e6] rounded-[4px] p-4 flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold text-[#5e6c84] uppercase tracking-wide">Active Review Flags</span>
            <AlertTriangle className="w-4 h-4 text-[#ff5630]" />
          </div>
          <div className="mt-2.5 flex items-baseline gap-1.5">
            <span className="text-[20px] font-bold text-[#172b4d] leading-none">2 Flags</span>
        ...
        <div className="bg-[#f4f5f7] border border-[#dfe1e6] rounded-[4px] p-4 flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold text-[#5e6c84] uppercase tracking-wide">Compliance Verification Rate</span>
      ...
      <div id="filtering-workspace-bar" className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-white p-3 border border-[#dfe1e6] rounded-[4px]">
        ...
        <div className="flex items-center gap-1.5">
          <button 
            ...
            className={`h-[28px] px-3.5 text-[11px] font-semibold rounded-[3px] transition-colors cursor-pointer ${
              filterMode === 'all' 
        ...
        <table className="w-full text-left border-collapse font-sans text-[11px]">
          <thead>
            <tr className="bg-[#fafbfc] border-b border-[#dfe1e6]">
              <th className="px-4 py-2.5 font-bold text-[#5e6c84] uppercase tracking-wide text-[10px] w-[180px]">Representative</th>
              <th className="px-3 py-2.5 font-bold text-[#5e6c84] uppercase tracking-wide text-[10px] w-[130px]">Core Status</th>
              <th className="px-3 py-2.5 font-bold text-[#5e6c84] uppercase tracking-wide text-[10px] w-[90px]">Duration</th>
              <th className="px-3 py-2.5 font-bold text-[#5e6c84] uppercase tracking-wide text-[10px] w-[120px] text-right">Tracked Updates</th>
              <th className="px-4 py-2.5 font-bold text-[#5e6c84] uppercase tracking-wide text-[10px]">AI Status Summary</th>
              <th className="px-4 py-2.5 font-bold text-[#5e6c84] uppercase tracking-wide text-[10px] w-[120px] text-center">Score / Tag</th>
            </tr>
          </thead>
          <tbody>
...
export { PageProductivity as pageProductivity };
