    ...
    <div id="surveys-page-container" className="flex flex-col gap-5 text-left font-sans">
      ...
      {feedbackMsg && (
        <div id="alert-banner-success" className="p-3 bg-[#e3fcef] border border-[#abf5d1] text-[#006644] rounded-[4px] text-[11px] font-semibold flex items-center gap-2">
          ...
          <div className="flex-1 font-sans">{feedbackMsg}</div>
        </div>
      )}
        ...
        <div className="xl:col-span-7 flex flex-col gap-4">
          <div className="border border-[#dfe1e6] rounded-[4px] overflow-hidden bg-white">
            <div className="bg-[#fafbfc] px-4 py-3 border-b border-[#dfe1e6]">
              <h3 className="text-[12.5px] font-bold text-[#172b4d] uppercase tracking-wider m-0 font-sans">
                Survey Delivery Log
              </h3>
              <p className="text-[11px] text-[#5e6c84] m-0.5 font-sans">
                ...
                >
                  <div className="flex flex-col gap-1 max-w-[420px]">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-[#172b4d] font-sans">{survey.phone}</span>
                      <span className="text-[9.5px] text-[#5e6c84] bg-[#f4f5f7] px-1.5 py-0.5 rounded-[3px] border border-[#dfe1e6] font-mono">
                        Ext: {survey.agentExt}
                      </span>
                    </div>
                    <div className="text-[#5e6c84] font-medium leading-relaxed mt-0.5 font-sans">
                      {survey.explanation}
                    </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between border-b border-[#dfe1e6]/60 pb-1.5">
                      <span className="font-bold text-[11px] text-[#172b4d] flex items-center gap-1.5 font-sans">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="text-[9px] text-[#5e6c84] font-bold uppercase block mb-1 font-sans">Representative Name</label>
                        <input
                          type="text"
                          value={currentName}
                          onChange={(e) => handleEditChange(map.extension, 'name', e.target.value)}
                          className="w-full h-[26px] border border-[#dfe1e6] hover:border-[#a5adba] focus:border-[#0052cc] focus:outline-hidden text-[11px] px-2 rounded-[3px] bg-white text-[#172b4d] select-text font-sans"
                        />
                      </div>
                      <div>
                        <label className="text-[9px] text-[#5e6c84] font-bold uppercase block mb-1 font-sans">Zoho Profile ID</label>
                        <input
                          type="text"
                          value={currentZoho}
