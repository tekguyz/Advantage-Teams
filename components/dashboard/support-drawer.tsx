        ...
        <div className="flex-1 overflow-y-auto pr-1 text-[11.5px] text-text-charcoal flex flex-col px-4 py-5 md:px-6">
          ...
          <div className="bg-accent-blue/5 border border-accent-blue/15 rounded-[3px] p-3 mb-3">
            ...
            <p className="text-[11px] text-text-muted leading-relaxed">
              Advantage Software — Teams links office calls with CRM customer records to automate feedback surveys. Walk through these sections to learn about employee verification rules and survey filters.
            </p>
          </div>
              ...
              <div className="flex flex-col gap-3.5 animate-fadeIn">
                <div>
                  ...
                  <p className="text-[11.5px] leading-relaxed text-text-muted text-justify">
                    This portal supports office representatives working on customer accounts. By matching phone extensions with active member profiles in Advantage Software — Teams, interactions are automatically verified so representatives receive proper evaluation credit:
                  </p>
                </div>
            ...
            {activeTab === 'policies' && (
              <div className="flex flex-col gap-3.5 animate-fadeIn">
                <div>
                  ...
                  <p className="text-[11.5px] leading-relaxed text-text-muted text-justify">
                    To maintain professional standards and prevent customer fatigue within Advantage Software — Teams, the system applies automated filters before queueing any outbound messages:
                  </p>
                </div>
